...
/**
 * DTO de salida para retornar una Semilla al cliente.
 *
 * <p>Convierte la entidad JPA en tipos simples y cadenas ISO para la
 * fecha. Incluye el NIT del proveedor en lugar de la entidad completa.
 */
public class SemillaResponse {
    ...
    public SemillaResponse(String codigo, String nombre, double precio, int stock,
                           String tipoSemilla, double porcentajeGerminacion,
                           String proveedorNit, String fechaIngreso) {
        this.codigo = codigo;
        this.nombre = nombre;
        this.precio = precio;
        this.stock = stock;
